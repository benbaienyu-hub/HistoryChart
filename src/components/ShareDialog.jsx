  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/20 px-6 backdrop-blur-sm">
      <motion.div
        ...
        className="w-full max-w-[420px] rounded-3xl border border-line bg-panel p-6 shadow-[0_24px_64px_-16px_rgba(0,0,0,0.3)]"
      >
        ...
        <div className="mt-5">
          ...
          <div className="space-y-1.5">
            ...
            {sharedWith.map((recipient) => (
              <div
                key={recipient}
                className="group flex items-center gap-2.5 rounded-xl bg-sunken px-3 py-2"
              >
                ...
                <button
                  ...
                  className="shrink-0 text-[11.5px] text-subink hover:text-danger"
                >
                  Remove
                </button>
              </div>
